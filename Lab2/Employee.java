//Derived class Employee from Person, implements Printable and Compensable
class Employee extends Person implements Printable, Compensable {
    ...
    public Employee(String name, int age, String address, String employeeID, String department, double salary, ISalaryCalculator salaryCalculator) {
